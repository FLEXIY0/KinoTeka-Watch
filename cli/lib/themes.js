...
var THEMES = {
    classic_bw: {
        ...
        colors: {
            ...
            highlight: [255, 255, 255],   // Белый
            muted: [120, 120, 120],       // Приглушенный серый
            border: [110, 110, 110],      // Рамки ч/б
            good: [232, 151, 95],         // #e8975f оранжевый (только цифры прогресса/таймкодов)
            warn: [232, 151, 95],         // #e8975f оранжевый (только цифры рейтинга ★ 8.5 и 1080p)
            bad: [200, 90, 90],
            titleBg: [15, 15, 15],
            cardBg: [0, 0, 0]
        },
